...
export class CreateDynamicScrapeDto {
  @ApiProperty({
    description: 'The URL to scrape',
    example: 'https://spa-app.com',
  })
  @IsUrl()
  url: string;
  ...
  @ApiProperty({
    description:
      'User agent to use for the request. Must be a browser user agent (CHROME, FIREFOX, SAFARI, EDGE) for JavaScript execution.',
  ...
  @ApiProperty({
    ...
    enum: Object.keys(WaitUntilType),
    required: false,
    example: 'SMART',
  })
  @IsOptional()
  @IsEnum(Object.keys(WaitUntilType))
  waitUntil?: string;
  ...
  @ApiProperty({
    description: 'Maximum time to wait for content (milliseconds)',
    minimum: 1000,
    maximum: 60000,
    required: false,
    default: 30000,
  ...
  @ApiProperty({
    description: 'Block image loading for faster scraping',
    required: false,
    default: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Block CSS loading for faster scraping',
    required: false,
    default: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Block font loading for faster scraping',
    required: false,
    default: false,
  })
  @IsOptional()
